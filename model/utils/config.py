...
# log and diaplay
  ...
  # TODO mattnet
  # Data input settings
  parser.add_argument('--ref_dataset', type=str, default='refcoco', help='name of dataset')
  ...
  # FRCN setting
  parser.add_argument('--ref_imdb_name', default='coco_minus_refer', help='image databased trained on.')
